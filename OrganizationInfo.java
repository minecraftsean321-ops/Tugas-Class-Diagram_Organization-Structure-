...
class Head implements OrganizationInfo{
    ...
    public void showInfo() {
        ...
        System.out.println("Head Name: " + namaKetua);
        System.out.println("Head Email: " + email);
        makeDecision();
    }
}
...
class Treasurer implements OrganizationInfo{
    ...
    void recordExpense (String description, double amount){
        ...
        System.out.println("Expense Description: " + description);
        System.out.println("Organization Expense: " + amount);
    };
    ...
    public void showInfo () {
        ...
        System.out.println("Treasurer Name: " + nama);
        System.out.println("Treasurer Email: " + email);
        System.out.println("Balanced total: " + balanced);
        recordExpense("Office tools", 150000);
    }
...
void evaluateStudent (String studentName, double score){};
    ...
    public void showInfo () {
        ...
        System.out.println("Schedule " + (i + 1) + ": " + schedule[i]);
        }
    }
}
...
public void showInfo () {
    ...
    System.out.println("Organization Partner: " + organization); 
...
class Internal implements OrganizationInfo {
    ...
    public void showInfo () {
        ...
        System.out.println("Internal Email: " + email);
